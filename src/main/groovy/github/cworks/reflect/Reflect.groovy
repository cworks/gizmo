...
public class Reflect {
     ...
     * @see #on(Class)
     */
    def static Reflect on(String name) throws ReflectException {
     ...
     * @see #on(Class)
     */
     def static Reflect on(String name, ClassLoader classLoader) throws ReflectException {
     ...
     * @return A wrapped class object, to be used for further reflection.
     */
    def static Reflect on(Class<?> clazz) {
     ...
     */
    def static Reflect on(Object object) {
     ...
     */
    def static Reflect on(Constructor<?> constructor, Object... args) throws ReflectException {
        try {
